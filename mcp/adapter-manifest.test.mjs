...
test("X1 runtime adapter manifest derives tool inventory and capability matrix", async () => {
  ...
  assert.deepEqual(manifest.mcp.tools.map((tool) => tool.name), ["membrane_context", "membrane_source_read", "membrane_knowledge_propose", "membrane_checkpoint_save", "membrane_checkpoint_load", "membrane_working_context", "membrane_temporal_fact", "membrane_scratchpad", "membrane_feedback"]);
