...
test("X1 runtime adapter manifest exposes native tool inventory and capability matrix", async () => {
  ...
  assert.deepEqual(manifest.mcp.tools.map((tool) => tool.name), [
    ...
    "membrane_temporal_fact", "membrane_scratchpad", "membrane_feedback", "membrane_ledger",
