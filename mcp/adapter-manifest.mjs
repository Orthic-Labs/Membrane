...
export async function buildAdapterManifest() {
  const matrix = JSON.parse(await readFile(new URL("../../sentinel/hooks/membrane-capability-matrix.json", import.meta.url), "utf8"));
  ...
  return {
    ...
    generated_from: ["mcp/server.mjs", "sentinel/hooks/membrane-capability-matrix.json", "docs/rightcontext/federation-freeze-v1.json"],
