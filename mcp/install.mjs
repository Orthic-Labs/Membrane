...
// tools/productization/generate-client-matrix.mjs and are intentionally
...
export const _MBR206_CLIENT_CAPABILITIES_PATH = _mbr206Join(_MBR206_REPO_ROOT, "operations", "clients.capabilities.v1.json");
export const _MBR206_SUPPORT_MATRIX_PATH = _mbr206Join(_MBR206_REPO_ROOT, "docs", "clients", "support-matrix.v1.json");
export const _MBR206_CLIENT_REGISTRY_PATH = _mbr206Join(_MBR206_REPO_ROOT, "operations", "clients.yaml");
export const _MBR206_OPERATIONS_INDEX_PATH = _mbr206Join(_MBR206_REPO_ROOT, "operations", "operations", "operations-index.v1.golden.json");
