...
def main():
    ...
    run('git', 'commit', '-m', 'ci(blueprint): remove consumed test-gated patch transport\n\nAll four scoped source changes passed their declared Node regressions. Remove the one-use payloads; the broader no-build corpus remains a separate acceptance gate.')
