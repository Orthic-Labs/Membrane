...
export function renderProductDoc(truth, platforms) {
  return [
    ...
    ...axisTable(truth),
    "",
    `Current supported target is **${truth.currentTarget}**. Cortex is **${truth.cortexScope}**; visible native **${truth.residentServiceAuthority}** owns resident lifecycle, **${truth.runtimeExecutionHost}** executes runtime, & Hub dashboard is **${truth.dashboardResidency}**.`,
    "",
    "## Platform status",
    "",
