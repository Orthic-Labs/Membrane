...
const fixture = () => {
  ...
  const platform = (os, suffix) => {
    ...
    return { os, vector_dispatch: "CRYPT_VECTOR_DISPATCH_V2", contract, receipt: file(`${suffix}.receipt`, JSON.stringify(base)) };
  };
