...
and final reseal with `blueprint doctor --full --json` without asking permission between
...
```bash
blueprint build --out .agent   # build/refresh map.json, .agent/manifest.json, generated docs, etc.
