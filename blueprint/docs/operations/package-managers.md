...
Cortex publishes through several channels, all converging on immutable
...
ruby -c release/homebrew/cortex.rb.template
...
before Cortex reports the channel published.
