...
- Cortex is the canonical CLI. README, SKILL, IMPLEMENTATION-STATUS, and package description use
  Cortex naming; prose brands nodes/edges/flows as Neurons/Synapses/Circuits. No unshipped
...
- Declared exact hashing, Tree-sitter runtime, and grammar dependencies so a clean checkout can run Cortex and its tests.
