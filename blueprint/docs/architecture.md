...
- Stale claims: **61** _(source: .agent/stale.json:staleClaims)_
- Missing references: **106** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `117f7a75b27e51b122deba6e8a697b4d`. Unchanged-repo rebuilds are byte-identical.
