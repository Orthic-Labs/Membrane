...
TranscriptEventV1 substrate at ``tools/skills/legion/lib/orthic_transcripts`` and
...
TRANSPORT_GAP_NOTE: str = (
    ...
    "(tools/skills/legion/lib/orthic_transcripts) is the canonical semantic source. "
