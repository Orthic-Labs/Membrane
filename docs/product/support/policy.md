...
[`docs/reference/clients/support-matrix.v1.json`](../../reference/clients/support-matrix.v1.json):
...
claiming installed support ([`docs/reference/evaluation/mbr801-evidence.md`](../../reference/evaluation/mbr801-evidence.md)).
...
tests ([`docs/reference/clients/README.md`](../../reference/clients/README.md)). Updates are transactional
and receipt-backed (see [update admission](../../architecture/security/update-admission.md)
