...
|---|---|---|
| MCP server | `engine/crates/membrane-mcp/` | 24 native tools over stdio and authenticated Hub loopback transport |
...
- `membrane_context` and the other 23 MCP tools are the client contract;
