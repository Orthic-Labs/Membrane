...
|---|---|---|
| MCP server | `engine/crates/membrane-mcp/` | 19 native tools over stdio and authenticated Hub loopback transport |
...
- `membrane_context` and the other 18 MCP tools are the client contract;
