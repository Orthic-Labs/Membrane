...
|---|---|---|
| MCP server | `engine/crates/membrane-mcp/` | 22 native tools over stdio and authenticated Hub loopback transport |
...
- `membrane_context` and the other 21 MCP tools are the client contract;
