...
- scheduled externally by tray/daemon control lifecycle.
...
- tray/daemon lifecycle boundary.
...
| `docs/architecture/membrane.md` | canonical Membrane architecture/implementation authority |
| `docs/architecture/subsystems/adapt.md` | canonical Adapt product semantics, Taste/Insights authority, lifecycle, evaluation, and feature dependencies |
...
Current open/closed state is derived only in [`../pending/README.md`](../pending/README.md)
from subsystem canons.
