...
| 2026-07-12 | Node MCP adapter (G5 Lane F) | Versioned packet contract | `tools/mcp/rightcontext_server.mjs` + client — stdio JSON-RPC cross-client door, 9 parity tests; the v4 Rust `memright mcp` verb is chartered to replace it |
