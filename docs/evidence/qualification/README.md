...
(MBR-808) derives the published support-tier matrix (`docs/product/support/matrix.md`,
`docs/product/support/matrix.json`, the README support-tier block, and `server.json`'s
