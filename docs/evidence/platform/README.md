...
Do not treat synthetic tests or `source-ready` receipts as macOS artifact acceptance. Redact machine identifiers when they contain personal or credential data.
