...
| Path | Consumed by |
| --- | --- |
| `docs/evidence/qualification/` | `scripts/tools/productization/generate-support-matrix.mjs`, which derives `docs/product/support/matrix.md`, `docs/product/support/matrix.json`, the README support-tier block, and `server.json` platformReceipt fields from these receipts. |
...
| `docs/evidence/platform/` | Referenced from `docs/reference/release/platform-acceptance.md`. |
