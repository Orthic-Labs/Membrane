...
source change. See `docs/reference/sdk/python-publishing.md` for the publishing
...
`tools/call` stub documented in `docs/reference/sdk/http-transport.md`; see
`docs/reference/sdk/python-publishing.md`'s "Known gap".
