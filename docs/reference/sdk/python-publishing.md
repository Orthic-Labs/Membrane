...
- `pyproject.toml` moves from placeholder `version = "0.0.0"` to `0.1.0`,
  matching the `0.1` semver baseline `docs/reference/sdk/publishing.md` already
...
gates the Rust crates in `docs/reference/sdk/publishing.md`.
...
`docs/reference/sdk/python.md`'s "Daemon compatibility" section for what it proves
...
Per `docs/reference/sdk/http-transport.md` (MBR-308), the shared `McpServer::dispatch`
