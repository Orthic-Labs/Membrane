...
| `docs/reference/clients/support-matrix.v1.json` | Generated client × operation matrix. Conforms to `schemas/client-support-matrix.v1.schema.json`. |
...
- `docs/architecture/runtime/tray-daemon-contract.md` — tray-owned resident lifecycle frames
  that owns the loopback port clients reuse.
- `docs/product/installation/contract.md` — the resident ↔ client handshake.
