...
if (!degraded) {
  ...
  process.stdout.write(JSON.stringify({ executionMode: "fixture", evidenceAuthority: "synthetic", packet: { schema: "membrane.context-packet.v1", task: "orient me", blocks: [{ source: "fixture", text: "Membrane is receipt-bound." }] }, receipts: [{ receipt_id: receipt.receipt_id, repository_id: receipt.repository_id, scope_id: receipt.scope_id, status: "fixture-admitted" }], providerStatus: "fixture", degradationReason: "fixture_only" }, null, 2) + "\n");
