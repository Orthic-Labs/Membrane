...
`docs/reference/protocol/source-of-truth.md`). The same crate is also the source of
...
- Per-shape (the five typed shapes): `docs/reference/protocol/source-of-truth.md`.
