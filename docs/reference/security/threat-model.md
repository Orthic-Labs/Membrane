...
| Corrupt or partial registry | Atomic write, schema failure is fail-closed | [MCP threat model](../../architecture/security/mcp-threat-model.md), [`mcp/installation-binding.test.mjs`](../../../mcp/installation-binding.test.mjs) |
