...
| --- | --- | --- |
| Provenance JSONL metadata | `<MEMBRANE_DATA_ROOT>/provenance.jsonl`; append-only; lifetime of install unless user wipes | [`runtime-privacy.md`](../../product/legal/runtime-privacy.md) |
| Scope-grant token or digest | Provenance row only when caller supplies it; treated as sensitive | [`PRIVACY.md`](../../product/legal/PRIVACY.md), [`runtime-privacy.md`](../../product/legal/runtime-privacy.md) |
...
retention limits are documented in [`runtime-privacy.md`](../../product/legal/runtime-privacy.md#6-user-rights).
