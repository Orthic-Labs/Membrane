...
```
docs/reference/examples/providers/blueprint_example/
...
```sh
rightkit cargo run --manifest-path docs/reference/examples/providers/blueprint_example/Cargo.toml --bin blueprint_example
```
