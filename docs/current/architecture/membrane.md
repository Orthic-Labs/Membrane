...
| `docs/current/architecture/membrane.md` | canonical Membrane architecture/implementation authority |
| `docs/current/architecture/subsystems/adapt.md` | canonical Adapt product semantics, Taste/Insights authority, lifecycle, evaluation, and feature dependencies |
