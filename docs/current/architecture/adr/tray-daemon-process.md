...
- Tray/daemon IPC, readiness, supervision, & failure semantics are defined in
  [`../runtime/tray-daemon-contract.md`](../runtime/tray-daemon-contract.md).
- Dashboard remains an on-demand Tauri client.
- Platform-specific implementation & qualification state stays in atom ledgers, not this decision.
