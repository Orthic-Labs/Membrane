...
Open implementation work is indexed by atom ID in `docs/pending/README.md` and may be
scheduled only after its production-path evidence establishes a verified gap. Host-owned work remains
