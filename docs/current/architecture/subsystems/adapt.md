...
**Companion Membrane doctrine:** `docs/current/architecture/membrane.md`
**Companion runtime plan:** `migration/native-rust/MEMBRANE-NATIVE-RUST-MIGRATION-AND-CODERIGHT-INTEGRATION.md`  
**Companion Ledger plan:** `docs/current/architecture/subsystems/ledger.md`
**Companion CodeRight integration plan:** `docs/current/architecture/integrations/coderight.md`
...
6. `docs/archive/architecture/derived/subsystems/adapt.md` and `adapt/README.md` — concise projections only; they MUST NOT invent competing semantics.
