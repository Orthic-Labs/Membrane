...
- Missing references: **42** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `bc4a55abf305a7cad6c5dbfca7cbd49c`. Unchanged-repo rebuilds are byte-identical.
