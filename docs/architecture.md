...
- Stale claims: **49** _(source: .agent/stale.json:staleClaims)_
- Missing references: **75** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `5a8b101d8ed43915a2c2ce180588cee2`. Unchanged-repo rebuilds are byte-identical.
