...
- Stale claims: **27** _(source: .agent/stale.json:staleClaims)_
- Missing references: **30** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `2fe61ad5eea0a38e092e6a496cbfe276`. Unchanged-repo rebuilds are byte-identical.
