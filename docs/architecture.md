...
- Missing references: **60** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `47d9d0fea8e336eb14ea7434c912f1cd`. Unchanged-repo rebuilds are byte-identical.
