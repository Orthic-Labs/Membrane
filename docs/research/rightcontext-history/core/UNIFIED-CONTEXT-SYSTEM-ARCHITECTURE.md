...
Until this design is implemented and accepted, `tools/lib/CONTEXT-ENGINEERING.md` remains the source
of truth for live operational behavior. This document defines the corrected product boundary and
the target that implementation plans must satisfy.
...
## 19. Related local sources

- `tools/lib/CONTEXT-ENGINEERING.md` — current operational context-economy and MemRight wiring.
...
- `docs/plans/2026-07-10-blueprint-code-graph-visual-explorer-impl.md` — current graph implementation plan; amended 2026-07-12 to conform (measured-optional portability, provider qualification, B3.5 flow inventory, stack-specific joins, MemRight drift gate, pinned-source mirror).
