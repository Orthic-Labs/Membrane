...
Historical & comparative inputs live here. They inform analysis but never override
current architecture, capability canons, or pending-work authority.

- [`legacy-source-corpus/`](legacy-source-corpus/README.md) — comparative research,
