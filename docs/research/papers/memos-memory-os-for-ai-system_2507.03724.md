---
title: memos-memory-os-for-ai-system
topic: context_memory
arxiv: 2507.03724
source: https://arxiv.org/abs/2507.03724
pages: 37
source_pdf_sha256: 9b9b71b61487ce9f01d2de014b80201d9a30c4fd43effa33e84ef7d2db824977
...
1MemTensor (Shanghai) Technology Co., Ltd., 2Institute for Advanced Algorithms Research,
Shanghai, 3Research Institute of China Telecom, 4Tongji University, 5Zhejiang University,
...
instruction and state consistency across multiple turns or stages.
...
dimensions.
For example, [19] categorizes memory into three types: parameter memory, unstructured
...
Through large-scale pretraining, LLMs encode syntactic structures,
conceptual relationships, and language usage patterns from corpora into their weight matrices.
These
...
Beyond the internalized parametric long-term memory, LLMs
...
Unlike short-term memory dependent on context windows, LLMs’
...
interactions.
2.2
Stage 2: Development of Human-like Memory
...
experience-driven personalized retrieval.
The system consists of three layers: L0 retains raw data for
completeness; L1 enhances organization and retrievability through structured natural language; L2 internalizes
user preferences via parameter tuning, enabling associative reasoning similar to humans.
AutoGen[96]
...
2.4
Stage 4: Systematic Memory Governance
...
Plaintext Memory
Plaintext memory refers to explicit, dynamically retrieved knowledge modules accessed
...
Activation Memory
Activation memory consists of intermediate states generated during inference, with the
...
i) and attention weights
(αl
ij), comprising the model’s runtime semantic perception. These are characterized as short-term, dynamic,
...
Parameter Memory
Parameter memory refers to knowledge and capabilities encoded in the model’s fixed
...
define each memory block’s identity, classification, and organization. Unified
...
provide systemic controls for memory access, security, and scheduling. In dynamic,
...
5.1
Overview: Three-layer Architecture of MemOS
...
The interface layer interacts with users or upstream systems and serves as the
...
The operation layer serves as the control center of MemOS, organizing, planning,
...
The infrastructure layer handles storage, security, migration, and flow
...
intelligent systems.
5.2
Execution Path and Interaction Flow of MemOS
...
System execution begins with a user-issued natural language
...
The MemOperator in the operation layer uses intent and context info
...
MemOS’s Three-Layer Architecture
Message Input
Message Output
MemReader
Memory Pipeline
...
After the candidate set is identified, MemScheduler optimizes memory
...
Scheduled memory units are passed to MemLifecycle for state
...
Evolved memories are archived in MemVault and organized
...
For example, a prompt like "Remind me what the doctor said about my
...
MemOS employs three complementary mechanisms for organizing
...
The MemOperator module supports hybrid retrieval mechanisms
...
Retrieved memory units are passed downstream as inputs to
...
To address the complexity of real-world tasks, MemOS employs a task-
...
During memory scheduling, MemScheduler analyzes
...
To maintain long-term performance and adaptive memory utilization,
...
MemScheduler integrates upstream with MemReader and the
...
To ensure long-term consistency and recovery, MemOS offers a
...
Lifecycle states directly influence scheduling priority and storage
...
6.1
End-to-End Evaluation on Long Context Memory
...
77.8
6.2
End-to-End Evaluation on Personalization and Preference Understanding
...
and preferences.
6.3
Evaluation of chunk sizes and Top-K selection
...
71.9
Table 6
We evaluated our MemOS-1031 model against various baselines on the PersonaMem [103] benchmark,
...
6.4
Evaluation of Memory Retrieval Robustness
...
6.5
Evaluation of KV-Based Memory Acceleration
...
7
MemOS for Architecture Innovation and Applications
7.1
Architectural Innovations Enabled by MemOS
...
7.1.1
Paid Memory as Modular Installables (User-Facing Paradigm)
...
7.1.2
Painless Memory Management (Task-Oriented Paradigm)
...
7.2
MemOS Application Scenarios
7.2.1
Supporting Multi-Turn Dialogue and Cross-Task Continuity
...
7.2.2
Supporting Knowledge Evolution and Continuous Update
...
7.2.3
Enabling Personalization and Multi-Role Modeling
...
7.2.4
Enabling Cross-Platform Memory Migration
...
[40] Zijian Feng, Hanzhang Zhou, Kezhi Mao, and Zixiao Zhu.
FreeCtrl: Constructing Control Centers with
...
Attention in Transformers: A cross-lingual exploration of knowledge.
...
[75] Ali Behrouz, Peilin Zhong, and Vahab Mirrokni.
Titans:
...
[93] Nils Reimers and Iryna Gurevych.
