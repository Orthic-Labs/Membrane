...
| ADP-022 | ADP-G01 | Adapt | COMMITTED | Represent proposal kind, intended effect, & intervention target independently under explicit compatibility policy, separate from issue/Taste authority. | PARTIAL | STALE | PENDING | PUSHED | REPAIR_WIRE | PENDING |
...
| ADP-036 | ADP-G01 | Adapt | COMMITTED | Measure procedural effectiveness only from exact joinable activation/evaluation/outcome plus asset-content & loaded-representation digests; never co-aggregate versions, otherwise unavailable. | PARTIAL | STALE | PENDING | PUSHED | REPAIR_WIRE | PENDING |
