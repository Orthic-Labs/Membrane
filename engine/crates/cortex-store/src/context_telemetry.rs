    ...
    fn add(
        ...
        let mut event = ContextEvent {
            ...
            producer: self
                ...
                .producer
                .clone()
                .unwrap_or_else(|| "membrane_planner".to_string()),
...
pub fn expand_context_lifecycle_intent(
    ...
    let membrane_terminal = builder.add(
        "membrane-terminal",
        "membrane",
        "provider.terminal",
    ...
    if intent.federation_status != "skipped" && intent.provider_results.is_empty() {
        let mut fields = lifecycle_fields(Some(membrane_terminal.span_id.clone()));
...
mod lifecycle_intent_tests {
    ...
    fn off_intent_value() -> Value {
        serde_json::json!({
            ...
            "policy_version": "membrane-policy-v1",
