use cortex::outline::build_outline;
use cortex::outline::build_outline_page;
use cortex::outline::read_section;
use cortex::outline::read_section_with_cursor;
use cortex::outline::DocReadError;
...
fn outline_reports_tokenizer_measured_model_estimates() {
    ...
    assert_eq!(
        ...
        Some(&cortex_core::estimate_tokens(span))
    );
    assert!(!section
        .token_estimates
        .per_model
