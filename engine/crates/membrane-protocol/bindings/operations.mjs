...
export const OPERATIONS = [
  ...
  {
    name: "membrane_memory_read",
    schemaVersion: 1,
    errorVersion: 1,
    schemaPath: "schemas/operations/membrane-memory-read.v1.schema.json",
    successFixture: "schemas/registry/operations/membrane-memory-read.v1.golden.json",
    errorFixture: "schemas/registry/operations/membrane-memory-read.v1.error.golden.json",
    errorCodes: [
      "caller_required",
      "installation_grant_denied",
      "repository_scope_chain_denied",
