...
fn fixture() -> tempfile::TempDir {
    ...
    let source = include_str!("fixtures/languages/kotlin/Runner.kt");
    fs::write(dir.path().join("Runner.kt"), source).unwrap();
    dir
}

#[test]
fn kotlin_functions_are_extracted() {
    let dir = fixture();
...
#[test]
fn kotlin_contains_edges_link_file_to_symbols() {
    let dir = fixture();
    let generation = build_generation(dir.path(), &GraphOptions::default()).unwrap();
