...
fn fixture() -> tempfile::TempDir {
    ...
    let source = include_str!("fixtures/languages/swift/runner.swift");
    fs::write(dir.path().join("runner.swift"), source).unwrap();
    dir
}

#[test]
fn swift_functions_are_extracted() {
    let dir = fixture();
...
#[test]
fn swift_contains_edges_link_file_to_symbols() {
    let dir = fixture();
    let generation = build_generation(dir.path(), &GraphOptions::default()).unwrap();
