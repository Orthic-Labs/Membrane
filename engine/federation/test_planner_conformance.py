...
def test_python_public_planner_drives_the_shared_matrix(monkeypatch, capsys):
    expected = FIXTURE["expected"]
    monkeypatch.setenv("MEMBRANE_MODE", "on")
    monkeypatch.setenv("MEMBRANE_COHORTS", "on")
    monkeypatch.setenv("MEMBRANE_POLICY_ENV_OVERRIDE", "1")
    monkeypatch.setenv("MEMBRANE_POLICY_TEST", "1")
    monkeypatch.setenv("MEMBRANE_CLIENT", "claude")
