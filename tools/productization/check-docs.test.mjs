...
//
// Run:  node tools/productization/check-docs.test.mjs
...
test("live source still reports nine tools and macOS+Windows tier 1", () => {
  assert.equal(truth.toolCount, 9);
  assert.deepEqual(platforms.tier1, ["macOS", "Windows"]);
});
