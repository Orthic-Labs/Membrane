...
|---|---|---|---|
| SEM-001 | Installed Hub-off explicit execution unreachable | Local unsigned 0.1.24 from `e18079e5` passes Hub-off probes; Hub-on watcher startup fails, so CodeRight remains paused pending installed acceptance | Every explicit subsystem operation remains available; only automatic work requires Hub |
